...
@eqx.filter_jit
def second_order_loss_fn(model: eqx.nn.MLP, batch: DifferentialData, key: PRNGKeyArray, ref_model: ReferenceModel, streaming_dirs: Array | None, streaming_svals: Array | None, variant: str, k: int, p: int, q: int) -> Float:
    """
